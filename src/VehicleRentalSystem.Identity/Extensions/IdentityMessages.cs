...
namespace VehicleRentalSystem.Identity.Extensions;
...
public class IdentityMessagesEnglish : IdentityErrorDescriber
{
    ...
    public override IdentityError InvalidUserName(string? userName)
    {
        return new IdentityError
        {
            ...
            Description = $"Login '{userName}' is invalid, can only contain letters or digits."
        };
    }
    ...
    public override IdentityError DuplicateUserName(string userName)
    {
        return new IdentityError
        {
            ...
            Description = $"Login '{userName}' is already taken."
        };
    }
